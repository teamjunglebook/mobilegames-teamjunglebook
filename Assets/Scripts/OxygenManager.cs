...
public class OxygenManager : MonoBehaviour {
	...
	public PlayerSwimController thePlayerController;
	...
	private void handleEnergyBar (float currentEnergyValue) {
		...
		if (currentEnergyValue > 50) {
			visualEnergy.color = new Color32 ((byte)MapEnergy(currentEnergyValue, 50, 100, 255, 0), 255, (byte)MapEnergy(currentEnergyValue, 50, 100, 0, 255), 255);
		} else {
